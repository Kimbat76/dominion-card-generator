...
const PRECACHE_CORE = 'precache-core-v46';
const PRECACHE_CARD = 'precache-card-v10';
...
const PRECACHE_CARD_URLS = [
  ...
  'card-resources/CardColorBottomGrad.png',
  'card-resources/DescriptionOverlayGradient.png'
];
